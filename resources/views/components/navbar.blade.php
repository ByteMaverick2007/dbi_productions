        ...
        <div class=" fixed z-10 top-0 left-0 right-0 mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-7 lg:px-2">
            <div class="sm:flex sm:items-center sm:justify-between">
                <div class="text-center sm:text-left">
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">DBI Production</h1>

                    <p class="mt-1.5 text-sm text-gray-500">Blog arsip dbi</p>
                </div>
                ...
                <div class="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                    <button
                        ...
                        type="button">
                        <span class="text-sm font-medium"> View Sosmed </span>
